...
export function AppShell({ profile, loginCompleted }: { profile: { displayName: string; avatarUrl: string | null }; loginCompleted: boolean }) {
  ...
  async function logout() {
    ...
    if (response.ok) { router.replace("/auth"); router.refresh(); return; }
    setLoggingOut(false);
  }
