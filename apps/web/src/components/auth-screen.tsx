...
export function AuthScreen({ errorCode, requestId, flow, returnTo = "/workspace" }: { errorCode?: string; requestId?: string; flow?: string; returnTo?: string }) {
