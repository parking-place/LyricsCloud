...
export function RhymeListScreen({ initialQuery }: { initialQuery: RhymeListQuery }) {
  ...
  return <section className="rhymes-page" aria-labelledby="rhymes-title">
    <header className="rhymes-heading"><div><p className="eyebrow">Release · 1.0.0</p><h1 id="rhymes-title" tabIndex={-1} data-login-focus>라임 노트</h1><p>떠오른 단어와 표현을 모으고, 곡으로 이어가세요.</p></div><a className="primary-link new-rhyme-link" href="/rhymes/new">＋ 새 라임 노트</a></header>
