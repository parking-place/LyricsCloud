...
export function TemplateScreen({ initialQuery }: { initialQuery: TemplateListInput }) {
  ...
  return <section className="templates-page" aria-labelledby="templates-title">
    <header className="templates-heading"><div><p className="eyebrow">Reusable starting points · 0.8.0</p><h1 id="templates-title" tabIndex={-1} data-login-focus>템플릿</h1><p>반복하는 가사 구조와 프롬프트 조합을 원본과 분리해 새 작업에 적용하세요.</p></div><button className="primary-link" type="button" onClick={beginCreate}>＋ 새 템플릿</button></header>
