...
// React scopes this memoization to one server render/request, never to an account-global cache.
export const resolvePageUser = cache(async (): Promise<{ userId: string; displayName: string; avatarUrl: string | null } | null> => {
