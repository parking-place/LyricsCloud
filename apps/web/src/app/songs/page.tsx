...
export default async function SongsPage({
  ...
  searchParams: Promise<{ auth?: string; search?: string; status?: string; work?: string; sort?: string }>;
}) {
  ...
  const initialQuery: SongListQuery = {
    ...
    work: workFilters.includes(query.work ?? "") ? query.work as SongListQuery["work"] : "all",
