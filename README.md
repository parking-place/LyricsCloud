...
현재 운영 서버의 정식 릴리스는 [`v1.1.7`](https://github.com/parking-place/LyricsCloud/releases/tag/v1.1.7)이고, 별도 `release/1.1.7a` 기반 1.1.7a Phase 5 최종 후보 인수를 진행한다. 미완료 1.1.8 Windows/main은 이번 후보에 넣지 않는다.
...
| 정식 릴리스 | `v1.1.7`, tag/운영 `edb8b4a`, exact digest 운영 배포; `v1.1.7a`는 P5 gate 전 미발행 |
| 개발 인수 | 1.1.7a P1~P4 완료; P5 최종 artifact·CI·동일 SHA 개발 인수 진행 중 |
