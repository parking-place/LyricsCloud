...
현재 운영 서버의 정식 릴리스는 [`v1.1.7`](https://github.com/parking-place/LyricsCloud/releases/tag/v1.1.7)이고, 별도 `release/1.1.7a` 기반 1.1.7a Phase 5 최종 후보 인수를 완료해 정식 릴리스를 준비한다. 미완료 1.1.8 Windows/main은 이번 후보에 넣지 않는다.
