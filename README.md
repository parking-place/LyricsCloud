...
- 로컬 검증을 완료한 개발 기준선: `0.0.0`
- 현재 Phase: [`0.0.0/5phase.md`](<./0.Plans/1. Dev-phase/0.0.0/5phase.md>) — 원격 Phase 브랜치 push 검토 대기
...
- 기준선 검증: [`0.0.0 통합 검증 보고서`](./docs/runbooks/0.0.0-release-readiness.md) 로컬 통과, 원격 push 확인 대기
