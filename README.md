...
현재 소스는 `1.0.9` 라임·프롬프트 사용자정렬의 Phase 5 최종 후보다. `v1.0.8`은 정식 태그·image·릴리스 서버 배포를 완료했다.
...
| 개발 인수 | 1.0.9 P1~P4, PostgreSQL 309건·Chromium 322건·5-project·동일 SHA 공개 순서/재시작 지속성 PASS |
