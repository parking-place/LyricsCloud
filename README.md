...
현재 소스는 `1.0.8` 곡 목록 사용자정렬이며 P1~P4 교차 회귀와 동일 SHA 공개 개발 인수를 완료했다. 현재 운영 버전은 `v1.0.7`이며 1.0.8 P5 최종 후보를 검증 중이다.
...
| 정식 릴리스 | 현재 `v1.0.7`; 1.0.8 P5 완료 후 승인된 main·tag·image·릴리스 서버 절차 실행 대상 |
| 개발 인수 | 1.0.8 P1~P4, PostgreSQL·전체 Chromium·5-project·동일 SHA 공개 순서 지속성 PASS |
