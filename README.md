...
현재 소스는 `1.0.9` 라임·프롬프트 사용자정렬이며 P1 계약을 완료하고 저장/API 구현을 준비 중이다. `v1.0.8` 정식 태그 이미지는 현재 검증·발행 중이다.
...
| 항목 | 상태 |
|---|---|
| 소스·runtime version | `1.0.9` |
| 현재 작업 | [1.0.9 Phase 1 — 계약·실패 사례·담당 경계](<./0.Plans/2.Patch-phase/1.0.9/1phase.md>) |
