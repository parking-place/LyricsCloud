...
| `ADR-NF-003` | owner/actor·공유 protocol | 1.1.0 P1; 쓰기 확장 1.1.2~1.1.3 | Accepted for 1.1.0 selected-read; write/guest Proposed | [결정](../../docs/adr/ADR-NF-003-sharing.md) |
...
| `PROD-NF-005` | 공유 수신자와 공개 필드 | 1.1.0 P1, 1.1.1~1.1.3 확장 승인 | Accepted for 1.1.0 selected-read fields; later expansion Proposed | [결정](../../docs/product/PROD-NF-005-sharing-scope.md) |
