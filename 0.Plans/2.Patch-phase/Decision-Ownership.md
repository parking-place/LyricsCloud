...
| `PROD-NF-006` | 디자인 승인·점진 적용 | UX P5, 1.1.5~1.1.6 소비 | Accepted for B-1 incremental implementation; 기능 삭제 없음, P4 의미 불변 수정 | [결정](../../docs/product/PROD-NF-006-ui-transition.md) |
...
| `PROD-NF-008` | 무료 폰트 선택·다국어 표시 | 1.0.14 P1 | Accepted for 1.0.14 | [결정](../../docs/product/PROD-NF-008-web-fonts.md) |
| `PROD-NF-009` | 여러 사용자 동시 작업과 위치 표시 | 1.1.0 P1; 1.1.2 P1 확장 | Accepted through 1.1.2 selected writer presence/cursor | [결정](../../docs/product/PROD-NF-009-collaboration-presence.md) |
...
`OPS-RD-117B-001`은 사용자 지정 순서 a→b→1.2.0을 반영하고, `OPS-RD-117B-002`는 정확한 b 버전 지원 계약이다. `PLAN-RD-117B-PORT`의 최초 웹 코드 통합은 b가 맡고 기존 후속 ID는 잔여 수용을 맡는다. [변경 결정](../3.Redesign-phase/PLAN-CHANGE.md)을 따르며 과거 a의 정식발행 예외는 승계하지 않는다.
