...
| `ADR-NF-003` | owner/actor·공유 protocol | 1.1.0 P1; 링크 읽기 1.1.1; 쓰기 확장 1.1.2~1.1.3 | Accepted through 1.1.3 public-link guest body write | [결정](../../docs/adr/ADR-NF-003-sharing.md) |
...
| `PROD-NF-005` | 공유 수신자와 공개 필드 | 1.1.0 P1, 1.1.1~1.1.3 확장 승인 | Accepted through 1.1.3 public-link guest body write | [결정](../../docs/product/PROD-NF-005-sharing-scope.md) |
