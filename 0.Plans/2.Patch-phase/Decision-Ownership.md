...
|---|---|---|---|---|
| `ADR-NF-001` | 베타 접근·해시 allowlist·원자 grant | 1.0.1 P1 | Proposed | [결정](../../docs/adr/ADR-NF-001-beta-access.md) |
...
| `PROD-NF-001` | 가입·일회용 코드 동선 | 1.0.1 P1 | Proposed | [결정](../../docs/product/PROD-NF-001-beta-onboarding.md) |
| `PROD-NF-002` | 원문·mode·송폼·복사 경고 | 1.0.3 P1; 1.0.4~1.0.6 확장 | Proposed | [결정](../../docs/product/PROD-NF-002-editor-output.md) |
| `OPS-NF-001` | 번호·main·정식 별칭 | 1.0.1 P1 | Proposed | [결정](../../docs/operations/OPS-NF-001-version-release.md) |
