# 1.1.12 Phase 3 — 플랫폼 목업·구현 범위 승인
...
- [ ] `LC-NF-1.1.12-P3-01` 확정 morphism 방향으로 new_Mock-up의 PC 변형에 Linux 탐색·창·키보드·편집·공유·사전·폰트·복구 상태를 문서화한다.
- [ ] `LC-NF-1.1.12-P3-02` 기존 PC/iOS/Android 목업을 재사용하되 OS별 차이와 읽기/작성/오프라인 범위를 명시한다. 웹 wrapper를 완전 native 충족으로 간주하지 않는다.
- [ ] `LC-NF-1.1.12-P3-03` spike 결과·패키징·유지비·실기기·개인정보·권리·rollback을 사용자에게 보여 주고 조건부 P4 앱 구현 승인 여부를 기록한다.
