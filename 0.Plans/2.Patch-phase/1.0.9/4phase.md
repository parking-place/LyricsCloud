...
- 상태: **회귀 후보 완료** (`implementation`, 원격 CI·동일 SHA 개발 인수 대기)
...
- [ ] `LC-NF-1.0.9-P4-05` 직전 버전·다른 계정·오프라인·재접속·서버 재시작·지원 브라우저/기기 회귀를 수행하고 미실행/skip의 원인을 기록한다. (브라우저 회귀 완료, 동일 SHA 개발 재시작 대기)
