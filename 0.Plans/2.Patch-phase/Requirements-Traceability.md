...
| `NF-REQ-037` | light/dark 디자인 개편안 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [NF-REQ-048의 시안 계약](contracts/DESIGN-NATIVE.md) | 대안·토큰·접근성·승인 후 점진 적용 | UX B-1 승인, 1.1.5 P1~P5 전체 CI·동일 SHA 개발 PC/mobile×dark/light 인수 완료; 후속 상세 화면 적용은 1.1.6 담당 |
...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1 승인·1.1.5 P1~P5 완료; 최종 추적·release artifact와 same child/store/API/DB·classic rollback·실제 OS 미실행 경계를 1.1.6에 인계 |
