...
| `NF-REQ-037` | light/dark 디자인 개편안 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [NF-REQ-048의 시안 계약](contracts/DESIGN-NATIVE.md) | 대안·토큰·접근성·승인 후 점진 적용 | UX B-1 승인, 1.1.5 P1~P5 전체 인수 완료; 1.1.6 P2 편집·자료·가입/공유/복구 양 theme flat surface와 classic rollback을 두 CI·동일 SHA 개발 공개 환경에서 인수 완료, P3 화면군 흐름 진행 중 |
...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1 승인·1.1.5 완료; 1.1.6 P2 stable editor lifecycle·navigation effect 분리와 10,000줄 theme/panel/viewport·undo·저장·heap, 동일 SHA 서버 저장 재진입을 인수 완료. 실제 OS gate는 P4/P5 유지, P3 진행 중 |
