...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1·1.1.5~1.1.6 완료. 1.1.7 P1은 PC와 Android/iOS browser 대리의 가입/수직 창작 6 PASS 및 정식 공유/복구 CI를 대조하고 새 라임/프롬프트 quick-add의 `returnTo` 유실을 P2 최소 범위로 확정했다. 외부 사전은 1.0.13 no-go, 실제 OS/물리 기기·IME/AT/OS zoom/OAuth callback은 미실행 |
