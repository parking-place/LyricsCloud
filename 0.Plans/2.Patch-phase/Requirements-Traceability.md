...
| `NF-REQ-037` | light/dark 디자인 개편안 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [NF-REQ-048의 시안 계약](contracts/DESIGN-NATIVE.md) | 대안·토큰·접근성·승인 후 점진 적용 | UX B-1 승인, 1.1.5 P1 계약·P2 token/classic rollback·P3 shell·P4 offline/restart 교차 회귀까지 동일 SHA 개발 인수 완료; P4 2개 CI·격리 DB PC/mobile 4 PASS·5-browser 10 PASS·공개 재시작 PASS, P5 예정 |
...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1 승인·1.1.5 P1 비파괴 계약·P2 flag/token·P3 shell 동일 SHA 개발 인수 완료; P4에서 editor DOM·offline exact body·recent filter/deep link·light/focus·owner 격리를 PC/mobile·5 browser engine·두 CI·동일 SHA 공개 재시작으로 완료, P5 예정 |
