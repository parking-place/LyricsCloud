...
| `NF-REQ-024` | 가사 최종 copy 3000자 경고 | [1.0.5](1.0.5/README.md), [1.0.12](1.0.12/README.md) | >3000 advisory, 입력/저장/복사 허용 | 1.0.5 기능 담당 완료, 1.0.12 통합 회귀 예정 |
| `NF-REQ-025` | [TAG:sub tag] 송폼 | [1.0.5](1.0.5/README.md), [1.0.12](1.0.12/README.md) | TAG 탐색·suffix 덜 강조·copy에는 suffix 유지 | 1.0.5 기능 담당 완료, 1.0.12 통합 회귀 예정 |
| `NF-REQ-026` | [Extend] metadata 제외 copy | [1.0.6](1.0.6/README.md), [1.0.12](1.0.12/README.md) | 원문에 보관, Suno용 전체 copy에서는 marker만 제외 | 1.0.6 기능·교차 회귀 완료, 1.0.12 통합 회귀 예정 |
| `NF-REQ-027` | 가사 우클릭 송폼 추천 | [1.0.6](1.0.6/README.md), [1.0.12](1.0.12/README.md) | 기본 송폼 삽입·키보드/모바일 대안·IME/undo 보존 | 1.0.6 기능·교차 회귀 완료, 1.0.12 통합 회귀 예정 |
...
| `NF-REQ-034` | 읽기 공유 3범위 | [1.1.0](1.1.0/README.md), [1.1.1](1.1.1/README.md), [1.1.4](1.1.4/README.md) | private 기본/selected 내부ID/public-link guest read | 1.1.0 selected-read·1.1.1 anonymous public-link read 완료, 1.1.4 삭제/복원·계정 전환 계약 승인·구현 대기 |
| `NF-REQ-035` | 쓰기 공유 3범위 | [1.1.2](1.1.2/README.md), [1.1.3](1.1.3/README.md), [1.1.4](1.1.4/README.md) | private/selected/public-link 및 guest 범위 명시 승인 | 1.1.2 selected-write·1.1.3 public-link guest write 완료, 1.1.4 복원/재접속·bounded queue 계약 승인·구현 대기 |
| `NF-REQ-036` | 쓰기 권한은 읽기의 부분집합 | [1.1.0](1.1.0/README.md), [1.1.1](1.1.1/README.md), [1.1.2](1.1.2/README.md), [1.1.3](1.1.3/README.md), [1.1.4](1.1.4/README.md) | 모드+실제 수신자 집합·서버/WS 검증·철회 | selected/public W⊆R 완료, 1.1.4 delete fence·old capability 비부활 계약 승인·구현 대기 |
