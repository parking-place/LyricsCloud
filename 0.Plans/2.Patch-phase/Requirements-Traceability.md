...
| `NF-REQ-026` | [Extend] metadata 제외 copy | [1.0.6](1.0.6/README.md), [1.0.12](1.0.12/README.md) | 원문에 보관, Suno용 전체 copy에서는 marker만 제외 | 1.0.6 P2 기반·P3 안내/원문 copy 완료, P4 통합 예정 |
| `NF-REQ-027` | 가사 우클릭 송폼 추천 | [1.0.6](1.0.6/README.md), [1.0.12](1.0.12/README.md) | 기본 송폼 삽입·키보드/모바일 대안·IME/undo 보존 | 1.0.6 P2 상대 위치·P3 PC/mobile UI 완료, P4 통합 예정 |
