...
| `NF-REQ-037` | light/dark 디자인 개편안 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [NF-REQ-048의 시안 계약](contracts/DESIGN-NATIVE.md) | 대안·토큰·접근성·승인 후 점진 적용 | UX B-1 승인, 1.1.5 P1~P4 동일 SHA 개발 인수 완료; P5 사용자/지원/보안/자가호스팅과 environment/migration/license/release artifact 봉인 후보 준비, 최종 CI·동일 SHA 개발 인수 대기 |
...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1 승인·1.1.5 P1~P4 완료; P5 최종 추적·release notes/checklist와 same child/store/API/DB·classic rollback·실제 OS 미실행 인계 후보 준비, 최종 CI·동일 SHA 개발 인수 대기 |
