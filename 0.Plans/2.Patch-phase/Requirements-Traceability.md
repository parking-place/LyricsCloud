...
| `NF-REQ-037` | light/dark 디자인 개편안 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [NF-REQ-048의 시안 계약](contracts/DESIGN-NATIVE.md) | 대안·토큰·접근성·승인 후 점진 적용 | UX B-1 승인, 1.1.5 P1 계약·P2 token/classic rollback 완료; P3 context header·rail/mobile nav·flat list/workspace와 light 대비가 전체 CI·네 dev image·동일 SHA 공개 개발 인수 완료; P4~P5 예정 |
