...
| `NF-REQ-040` | Windows 네이티브 개발안 | [1.1.8](1.1.8/README.md), [1.1.9](1.1.9/README.md) | 기술/IME/protocol 승인→구현/서명/실기기 인수 | 1.1.8 P1 WinUI 3/read-copy 권고안 사용자 승인. P2 native broker/read API·DPAPI account cache·copy fixture·1150 schema 완료. P3 후보 `b96200c`의 곡/가사·라임·프롬프트 native UI/exact copy·상태/접근성 계약·owner 가사 API, Actions `34922705406`·`34922708443` 전체 CI/Windows x64 build·개발 artifact와 동일 SHA 개발 인수 완료. P4/P5 실제 Windows UX·IME/AT·DPAPI/process kill·clipboard·DPI/다중 monitor·신뢰 서명 설치/업데이트/제거 및 1.1.9 editor gate 미완료 |
