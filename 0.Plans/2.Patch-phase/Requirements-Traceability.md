...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1·1.1.5~1.1.6와 1.1.7 P1~P3 완료. P3 후보 `740b1e3`은 exact 목록→편집→공유/Suno 복귀, 공유/mobile More focus 복귀, 접힌 rail 접근성 이름·40px target·focus tooltip을 5 browser profile과 동일 SHA 공개 PC/mobile×dark/light에서 통과했다. 외부 사전은 1.0.13 no-go, 실제 OS/물리 기기·IME/AT/OS zoom/OAuth callback은 미실행 |
