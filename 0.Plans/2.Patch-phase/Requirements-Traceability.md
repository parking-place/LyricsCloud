...
| `NF-REQ-037` | light/dark 디자인 개편안 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [NF-REQ-048의 시안 계약](contracts/DESIGN-NATIVE.md) | 대안·토큰·접근성·승인 후 점진 적용 | UX B-1 승인, 1.1.5 P1~P5 전체 인수 완료; 1.1.6 P1에서 편집·자료·가입/공유/복구 화면의 양 theme·classic rollback·접근성 계약 완료, P2 구현 대기 |
...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1 승인·1.1.5 완료; 1.1.6 P1에서 same editor DOM/store/API/DB·selection/undo/IME/outbox·보안/복구 의미 보존과 실패 입력을 고정, 실제 OS gate를 남기고 P2 구현 대기 |
