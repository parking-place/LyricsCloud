...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1 승인·1.1.5 완료; 1.1.6 P2~P5 stable editor lifecycle, 생성/연결 상태·mobile sheet/focus, copy/export·저장/재진입·restart와 최종 문서/CI/동일 SHA 개발 인수 완료. 실제 OS/물리 기기·IME/AT/OS zoom은 미실행으로 분리하고 남은 동선 범위는 1.1.7 이후가 계속 담당 |
