...
| `NF-REQ-037` | light/dark 디자인 개편안 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [NF-REQ-048의 시안 계약](contracts/DESIGN-NATIVE.md) | 대안·토큰·접근성·승인 후 점진 적용 | UX B-1 승인, 1.1.5 P1~P5 완료; 1.1.6 P2~P4 편집·자료·가입/공유/복구·생성/연결의 양 theme flat surface, classic rollback, exact copy/export·저장 재진입·서비스 재시작을 두 CI·signed image·동일 SHA 개발 공개 환경에서 인수 완료; P5 최종 추적 남음 |
...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1 승인·1.1.5 완료; 1.1.6 P2~P4 stable editor lifecycle, 생성/연결 input·loading/empty/error/retry·mobile sheet/focus, copy/export·저장/재진입·restart를 전체 브라우저와 동일 SHA 개발 공개 환경에서 인수 완료. 실제 OS/물리 기기·IME/AT/OS zoom gate와 P5 최종 추적은 유지 |
