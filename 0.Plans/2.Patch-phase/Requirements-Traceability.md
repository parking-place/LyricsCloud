...
| `NF-REQ-037` | light/dark 디자인 개편안 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [NF-REQ-048의 시안 계약](contracts/DESIGN-NATIVE.md) | 대안·토큰·접근성·승인 후 점진 적용 | UX B-1 승인, 1.1.5 P1 계약과 P2 양 theme semantic token·classic rollback 구현, 전체 CI·동일 SHA 공개 PC/mobile 인수 완료; P3~P5 예정 |
...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1 승인·1.1.5 P1 비파괴 계약, P2 server root flag/token 기반의 전체 CI·동일 SHA 저장/재진입/최근/deep-link 인수 완료; route/store/editor 불변, P3~P5 예정 |
