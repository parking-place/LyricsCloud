...
| `NF-REQ-040` | Windows 네이티브 개발안 | [1.1.8](1.1.8/README.md), [1.1.9](1.1.9/README.md) | 기술/IME/protocol 승인→구현/서명/실기기 인수 | 1.1.8 P1 WinUI 3/read-copy 권고안 사용자 승인. P2 후보 `dbfca88`의 native broker/read API·DPAPI account cache·copy fixture·1150 schema·1.1.8 환경 계약, Actions `34918857197`·`34918859682` 전체 CI/Windows build와 동일 SHA 개발 인수 완료. P3~P5 실제 Windows UX·IME/AT·설치/업데이트/제거·배포 서명과 1.1.9 editor gate 미완료 |
