...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1·1.1.5~1.1.6와 1.1.7 P1~P3 완료. P4에서 reduced transparency·contrast/forced-colors fallback을 추가했고 실제 PostgreSQL 380 PASS·Chromium desktop/mobile E2E 379 PASS·5-browser 집중 8 PASS로 reflow·저사양 대리·협업/presence/font/IME 영향을 로컬 확인했다. 후보 CI·동일 SHA 개발 공개 인수 대기. 외부 사전은 1.0.13 no-go, 실제 OS/물리 기기·IME/AT/OS zoom/OAuth callback은 미실행 |
