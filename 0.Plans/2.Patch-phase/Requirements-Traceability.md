...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1·1.1.5~1.1.6와 1.1.7 P1~P3 완료. P3 후보 `740b1e3`의 수직 복귀·focus·Suno/rail 개선을 실제 개발 환경까지 인수했고, P4에서 reduced motion/contrast·200% reflow·저사양 대리와 협업/presence/font/IME 영향을 재검토 중이다. 외부 사전은 1.0.13 no-go, 실제 OS/물리 기기·IME/AT/OS zoom/OAuth callback은 미실행 |
