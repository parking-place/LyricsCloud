...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1·1.1.5~1.1.6 완료. 1.1.7 P1 관찰 뒤 P2는 새 라임/프롬프트 quick-add의 안전한 `returnTo`와 생성/편집 back 복귀를 구현했다. 첫 CI의 기존 URL 14 FAIL을 보정하고 후보 `206b14f` 두 CI·네 signed dev image·동일 SHA 공개 1440/390px×light/dark의 exact URL/본문/focus/overflow 인수를 완료했다. 외부 사전은 1.0.13 no-go, 실제 OS/물리 기기·IME/AT/OS zoom/OAuth callback은 미실행 |
