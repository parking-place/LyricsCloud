...
| `NF-REQ-039` | UI/UX 동선 개선·개편 | [UX 설계](design/UX/README.md), [1.1.5](1.1.5/README.md), [1.1.6](1.1.6/README.md), [1.1.7](1.1.7/README.md) | 현행 과제 관찰·설계 비교·비파괴 전환 | UX B-1·1.1.5~1.1.6와 1.1.7 P1~P4 완료. P4 후보 `66f2f79`에서 reduced transparency·contrast/forced-colors fallback, 실제 PostgreSQL 380 PASS·Chromium E2E 379 PASS·5-browser 집중 8 PASS, 두 CI·네 signed dev image와 동일 SHA 공개 reflow/4x CPU 저장·서비스 재시작 영속을 인수했다. P5는 사용자/목업 탐색·플랫폼 공통/차이·29 migration 환경/license/release artifact를 로컬 봉인했고 후보 CI·동일 SHA 개발 인수를 기다린다. 실제 native SDK/OS/기기·IME/AT/OS zoom/서명/스토어는 미실행 |
