...
- 상태: **진행 중** (`in_progress`, 계약 후보 작성·원격 인수 전)
...
- [ ] `LC-NF-1.1.4-P1-06` 각 변경 파일 담당자와 실제 최종 source SHA를 기록한다. 해당 패치 밖의 기능이나 아직 선택하지 않은 아이디어를 섞지 않는다. — 담당·착수 main `0b265d6b7aaf686e83f895949d52ad030db8add2` 기록, 원격 후보 SHA 확인 뒤 완료
