...
상태: **P1~P3 완료 / P4 진행 중**. P3 제품 후보 `e6f9e8c266d3d61c7016aa51519ff4fc5703fdbe`의 두 CI·네 dev image·동일 SHA 개발 서버 저장 재진입과 공개 양 테마/desktop/mobile 생성·연결 흐름을 인수했다. runtime `1.1.6`은 아직 정식 제품이 아니다.
