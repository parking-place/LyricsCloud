...
- [1.1.6 P4](4phase.md)의 산출물·검증/승인과 실제 최종 SHA 인수.
...
- [ ] `LC-NF-1.1.6-P5-01` 1.1.6의 요구 범위와 각 수용 사례를 정확한 source SHA·변경 파일·migration·실행 명령·결과에 연결한다.
- [ ] `LC-NF-1.1.6-P5-02` 사용자 가이드·README·지원·보안·자가호스팅·현재 계획/결정 문서를 승인 디자인 적용·편집과 복구 화면의 실제 동작에 맞춰 갱신하고 과거 검증 기록은 보존한다.
...
- [ ] `LC-NF-1.1.6-P5-06` 후속 패치에 계약·미해결/보류·실기기/운영 증거·중단/복구 조건을 인계한다. 같은 제품 계열을 유지하고 빈 릴리스·자동 minor 승격을 만들지 않는다.
