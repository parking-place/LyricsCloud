...
상태: **P1~P4 완료 / P5 착수**. Noto Sans KR 2.004 Regular 자산·캐시, 선택 영속·세 편집기 적용과 slow/blocked/offline·장문 입력·성능 회귀를 인수했다. 실제 Windows/Android/iOS의 1.0.14 폰트 전환은 미실행 위험으로 유지한다. 요구 `NF-REQ-044`를 [전체 추적표](../Requirements-Traceability.md)로 연결한다.
