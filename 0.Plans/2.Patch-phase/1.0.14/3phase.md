...
- [ ] `LC-NF-1.0.14-P3-01` 설정에 승인 폰트 목록·대표 다국어 미리보기·선택 영속을 제공하고 가사/라임/프롬프트 편집 표시로 연결한다.
- [ ] `LC-NF-1.0.14-P3-02` 폰트 교체 시 cursor·selection·undo·scroll·IME 조합이 유지되고 원문/실제 copy output은 변경하지 않는다.
- [ ] `LC-NF-1.0.14-P3-03` 모바일 글자 확대·줄 높이·tooltip·presence label의 overflow와 접근성 이름을 확인한다.
