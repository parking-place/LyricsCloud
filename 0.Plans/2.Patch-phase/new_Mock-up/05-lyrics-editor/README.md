# 05-lyrics-editor — 가사 편집

## 목적과 정보

- 핵심 정보/동작: 본문, 저장 상태, 구조/라임/프롬프트/버전
- 적용 상태: 정상 · 로딩 · 오류 · 오프라인 · 미전송 · IME 조합
- 안전 기준: CodeMirror/Yjs 전환 시 focus, selection, undo, 조합 중간값을 보존한다.
...
- [대표 오류/복구 상태](mockup.html?theme=dark&platform=windows&state=ime)
