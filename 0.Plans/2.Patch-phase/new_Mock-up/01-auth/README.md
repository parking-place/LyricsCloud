...
- 핵심 정보/동작: 초대 코드 확인, Google 본인 확인
- 적용 상태: 정상 · 로딩 · 오류 · 코드 만료
- 안전 기준: 가입 코드를 소비하기 전에 오류와 다음 행동을 문장으로 알린다.
...
- 대표 오류/복구 상태: `mockup.html?theme=dark&platform=windows&state=code-expired`
