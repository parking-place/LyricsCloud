...
상태: **P1 기술 검토·reference spike 완료 / 사용자 승인 대기 / 구현 미착수**. 번호는 미발행 작업 배정이며 배포 승인이 아니다. [권고 결정안](../../../docs/runbooks/1.1.8-phase1-windows-native-decision.md)을 승인하기 전 P2로 진행하지 않는다.
