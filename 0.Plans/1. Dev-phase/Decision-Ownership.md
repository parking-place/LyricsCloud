...
| [`PROD-0008`](../../docs/product/PROD-0008-template-application.md) | 템플릿 적용 시 덮어쓰기·추가·취소와 기존 내용 보호 | [0.8.0 Phase 1](./0.8.0/1phase.md) | 0.8.0 Phase 5, 0.9.0 | `Accepted` |
| [`PROD-0009`](../../docs/product/PROD-0009-keyboard-shortcuts.md) | 단축키 조합, 실행 문맥, 운영체제별 키 표기 | [0.8.0 Phase 3](./0.8.0/3phase.md) | 0.8.0 Phase 5, 0.9.0 | `Accepted` |
...
| [`PROD-0011`](../../docs/product/PROD-0011-favorites-pins.md) | 즐겨찾기·핀의 독립 의미, owner별 전역 핀 순서와 삭제·복원 처리 | [0.7.0 Phase 4](./0.7.0/4phase.md) | [0.7.0 Phase 5](./0.7.0/5phase.md) | `Accepted` |
...
| [`OPS-0002`](../../docs/operations/OPS-0002-artifact-verification.md) | image registry, 서명, provenance와 digest 승인 목록 | [0.9.1 Phase 5](./0.9.1/5phase.md) | [1.0.0 Phase 2](./1.0.0/2phase.md) | `Accepted` |
| [`OPS-0003`](../../docs/operations/OPS-0003-performance-budget.md) | 기준 서버·DB 규모, 동시 작업 수와 성능 budget | [0.9.1 Phase 3](./0.9.1/3phase.md) | 0.9.1 Phase 4~5, 1.0.0 | `Accepted` |
| [`OPS-0004`](../../docs/operations/OPS-0004-final-release-gate.md) | 최종 gate 승인자, 예외 불가 조건과 운영 인수 책임 | [1.0.0 Phase 1](./1.0.0/1phase.md) | [1.0.0 Phase 5](./1.0.0/5phase.md) | `Accepted` |
