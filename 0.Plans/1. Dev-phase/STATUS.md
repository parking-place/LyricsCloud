...
|---|---|---|---|---|---|---|
| Codex | 0.4.0 / Phase 4 | LC-040-P4-01~08 | `packages/domain`, `packages/database`, `packages/editor`, `apps/web`, `tests/e2e`, 삽입 계약·Phase 문서 | 0.4.0 Phase 1~3 라임 owner·CRDT·복사 계약 | 2026-09-06 KST | in_progress |
