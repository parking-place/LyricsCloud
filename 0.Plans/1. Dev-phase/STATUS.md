...
next_action: "0.7.0 Phase 1 검색 계약·정규화·pg_trgm migration·owner/삭제 경계·점수·성능 회귀를 구현"
```
...
| 0.7.0 | in_progress | Phase 1 진행 중 | 0.6.0 완료 |
...
|---|---|---|---|---|---|---|
| Codex | 0.7.0 / Phase 1 | LC-070-P1-01~08 | 검색 계약·정규화·migration·query/service·DB 테스트·성능 기록·Phase 문서 | 0.6.0 완료 | 2026-09-07 11:56 KST | 진행 중 |
