...
current_phase: "../2.Patch-phase/1.0.1/1phase.md"
state: "active"
owner: "Codex"
started_at: "2026-09-09"
updated_at: "2026-09-09"
next_action: "P1의 실제 Windows IME 행렬과 인증 후 공개 UI 버튼·테마 재현을 완료해 최초 손실 지점을 확정한다"
```
...
|---|---|---|---|---|---|---|
| Codex | 1.0.1/P1 | LC-NF-1.0.1-P1-01~08 | 계약·인수 문서, editor/auth/UI 원인 경로 | P6 회귀·실제 Windows IME·공개 개발 HTTPS | 2026-09-09T17:55:11+09:00 | active |
...
1.0.1 P1의 자동 P6 감사 100건과 개발 서버·공개 live/ready/auth 기준은 [P1 인수 기록](../../docs/runbooks/1.0.1-phase1-intake.md)에 연결했다. 사용자 PC의 기존 Compose는 healthy지만 앱 `0.7.0`·schema `0701_recent_searches.sql`로 오래되어 현재 결함 판정에서 제외했고, source 갱신 전 DB custom archive와 목록 판독을 확인했다. Windows 실제 Microsoft 한국어 IME의 OS·브라우저·입력기 버전 및 전체 입력 행렬과 로그인 후 공개 버튼·테마 재현은 아직 미완료다.
