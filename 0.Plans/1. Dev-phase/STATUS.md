...
next_action: "0.3.0 Phase 4 전체·송폼 복사, 실패 대안과 PC·모바일 집중 모드를 구현·검증"
```
...
| 0.3.0 | in_progress | Phase 1~3 완료, Phase 4~5 대기 | 0.2.0 완료 |
...
|---|---|---|---|---|---|---|
| Codex | 0.3.0 / Phase 4 | LC-030-P4-01~10 | `packages/editor`, `apps/web`, `tests/e2e`, Phase·검증 문서 | Phase 3 section offset 계약 | 2026-09-05 14:38 KST | 진행 중 |
...
사용자의 2026-09-05 후속 지시에 따라 0.5.0까지 Phase를 순서대로 진행한다. 현재 0.3.0 Phase 3까지 완료했으며 다음은 [0.3.0 Phase 4](./0.3.0/4phase.md)이다.

Phase 4는 [가사 편집 화면 설명](../Mock-up/05-lyrics-editor/README.md), [PROD-0003 송폼](../../docs/product/PROD-0003-songform.md), [Phase 3 검증](../../docs/runbooks/0.3.0-phase3-validation.md)을 먼저 읽고, 현재 editor 문자열과 section offset을 이용해 전체·복수 구간 복사와 집중 모드를 연결한다. CRDT와 수정 기록은 0.3.1 범위를 유지한다.
