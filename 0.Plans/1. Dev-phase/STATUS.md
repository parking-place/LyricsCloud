...
current_phase: "../2.Patch-phase/1.1.1/1phase.md"
state: "in_progress"
owner: "Codex"
started_at: "2026-09-11"
updated_at: "2026-09-12"
next_action: "1.1.0 main/tag 068679d·정식 image·릴리스 서버 exact digest·공개 권한/재시작/오프라인 인수·GitHub Release 완료. 1.1.1 P1에서 public-link read capability·token·회수·cache/OG 경계를 최초 소비 전에 확정한다"
```
...
| 1.1.1 P1 | in_progress | public-link read capability·token digest/rotation·회수 epoch·cache/noindex/OG·호환/rollback·담당 경계 확정 |

## 활성 작업

| 담당자 | 버전/Phase | 작업 ID | 수정 경로 | 의존성 | 시작 시각 | 상태 |
|---|---|---|---|---|---|---|
| Codex | 1.1.1/P1 | LC-NF-1.1.1-P1-01~06 | public-link read capability·token·회수·cache/OG·호환/rollback·담당 경계 | v1.1.0 `068679d` | 2026-09-12 | in_progress |
