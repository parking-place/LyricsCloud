...
next_action: "1.0.7 P5 전체 CI와 동일 SHA 개발 인수를 완료한 뒤 승인된 정식 릴리스를 실행한다"
```
...
| 1.0.7 P5 | in_progress | 문서·봉인 artifact·전체 CI·동일 SHA 개발 인수와 정식 릴리스 준비 |
...
| Codex | 1.0.7/P5 | LC-NF-1.0.7-P5-01~06 | 최종 추적·사용자/운영 문서·봉인 artifact·전체 CI·동일 SHA 개발 인수 | 1.0.7 P4 `f096bb5` | 2026-09-11T06:20:00+09:00 | in_progress |
