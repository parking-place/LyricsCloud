...
- [ ] `LC-RD-124-P4-05` 백업 KILL 회복·위조 헤더·프로필 413·purge 지연을 개발 환경 인수 시나리오로 연결하고 복구 시간/실패 흔적을 남긴다. **[WC-14](../BRANCH-COMPARISON-118-P4.md)**의 기존 수정·회귀를 먼저 선별 인수한다: 지속 실패 20개 뒤 정상 문서가 굶지 않는 keyset/wrap·trash 제외·timer 재진입 방지·Y.Doc cleanup·timestamp/오류 marker 보존을 검사한다. worker purge M-04 완료와 구별한다.
