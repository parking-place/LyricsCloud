...
상태: **진행 중** (`in_progress`). 1.1.7b 문서 인수 `e8ce777fcee83396166d0afcf76ecbd932440406`에서 `phase/1.2.0-p1-contract-baseline`을 분기해 요구 `RD-REQ-001~006`의 계약을 담당한다. 제품 출발 기능 SHA는 `acd2bd99876740debf426c401fe7157713f8b854`다. 사용자 선택은 코발트 Chroma Dock으로 확정됐으며 같은 선택을 다시 요청하지 않는다.
