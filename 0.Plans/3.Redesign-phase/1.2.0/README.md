...
상태: **계획 준비 완료 / 제품 구현 미착수**. 2026-09-22 사용자 선택을 반영한 다음 제품 계획이다. 기준은 `v1.1.7a` / `fc2463cdb47d9fd7d0042779f602c6ddb7d734cf`이며, 1.1.8~1.1.14를 거치지 않고 이 버전으로 진행한다. [전환 결정](../PLAN-CHANGE.md)과 [계획 상태](../STATUS.md)를 함께 읽는다.
