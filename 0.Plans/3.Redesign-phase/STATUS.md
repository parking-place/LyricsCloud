...
next_planned_phase: "1.2.1/1phase.md"
selected_design: "Chroma Dock / Cobalt Blue (color study 04)"
deferred_patch_versions: "1.1.8 through 1.1.14"
implementation_state: "1.2.0 P1-P5 development acceptance complete; 1.2.1 not started"
execution_authorized_by_this_file: false
runtime_status_source: "0.Plans/1. Dev-phase/STATUS.md"
```

1.1.7b 통합 5 Phase는 [실행 STATUS](<../1. Dev-phase/STATUS.md>)의 기능 SHA `acd2bd9`로 개발 인수 완료다. 1.2.0 P1 계약·버전 전환 `84761ae`, P2 코발트 셸/홈/목록 `f4c9588`, P3 편집·자료·공유/복구 `a315c07`, P4 교차 회귀·접근성·성능 `c380a59`, P5 최종 문서·CI·개발 공개 인수 `125ab02`까지 완료했다. 사용자 선택인 코발트 디자인과 native 보류는 유지한다. 실기기/OS IME/AT는 후속 미실행이고 정식 발행은 별도 승인 대상이다.
...
| P5 | [문서·최종 통합·개발 인수](1.2.0/5phase.md) | complete | SHA `125ab02`·Actions `36070155034`/`36070158441`·네 signed Dev image·같은 SHA 공개 개발 인수; 실기기 미실행 |
