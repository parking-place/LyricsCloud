...
- [ ] `LC-RD-122-P4-03` 템플릿 형식 radio와 대상 변경의 무조건적인 내용 초기화를 제거한다. 기존 지원 형식별 초안 보관 또는 명시 변환 계약을 따른다. **[WC-09](../BRANCH-COMPARISON-118-P4.md)**의 b에 통합된 수정·회귀를 먼저 인수하고 미인수 잔여에만 추가 적용한다: 형식 왕복 원문과 locked fieldset을 인수하되 type/target/selection 전환 보호·UI-04/05는 별도로 구현한다.
