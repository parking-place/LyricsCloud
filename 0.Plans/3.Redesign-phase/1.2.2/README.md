...
[브랜치 비교표](../BRANCH-COMPARISON-118-P4.md)의 WC-02, WC-06, WC-09를 해당 Phase 작업과 수용표에 포함한다. b의 실제 통합 SHA를 출발점으로 삼고 새 1.2.x에서는 잔여와 디자인 전환 영향을 인수한다. 처음의 원격 포팅을 반복하지 않는다. native/1.1.8 metadata와 이전 계획 문서를 통째로 가져오지 않는다.
