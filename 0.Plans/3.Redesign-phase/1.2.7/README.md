...
[브랜치 비교표](../BRANCH-COMPARISON-118-P4.md)의 WC-15, WC-16를 해당 Phase 작업과 수용표에 포함한다. 이미 존재하는 수정 후보를 출발점으로 삼되 필요한 의존성만 가져오고 새 1.2.x SHA에서 인수한다. native/1.1.8 metadata와 이전 계획 문서를 통째로 가져오지 않는다.
