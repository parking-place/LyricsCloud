...
test("neutral shell fits the viewport and exposes health semantics", async ({ page }, testInfo) => {
  await page.goto("/");
  ...
  await page.screenshot({ path: `docs/runbooks/evidence/0.0.0-${testInfo.project.name}.png`, fullPage: true });
