...
for (const marker of ["NF-REQ-034", "NF-REQ-036", `AC-${currentVersion}-01`, `AC-${currentVersion}-04`, "공개 링크", "P0/P1", "OPS-100-001", "1110_public_lyric_read_links.sql"]) {
...
for (const marker of ["공개 링크", "읽기", "회수", "실제 OS", "알려진 제한", "OPS-100-001"]) {
...
assert(formalManifest.releaseVersion === currentVersion && formalManifest.releaseChannel === "release"
  && formalManifest.productionAuthorized === true && formalManifest.database.requiredLatestSchema === "1110_public_lyric_read_links.sql",
