...
for (const marker of ["cosign sign", "registry-referrers-mode=oci-1-1", "cosign verify", "experimental-oci11", "certificate-identity", "certificate-oidc-issuer", "Provenance.SLSA", "vcs:source", "configSource.path", "GITHUB_SHA"]) {
