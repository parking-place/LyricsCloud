...
for (const marker of ["cosign sign", "cosign verify", "experimental-oci11", "certificate-identity", "certificate-oidc-issuer", "Provenance.SLSA", "vcs:source", "configSource.path", "GITHUB_SHA"]) {
