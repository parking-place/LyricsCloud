...
const schema = JSON.parse(await readFile(new URL("../config/environment-schema.1.0.6.json", import.meta.url), "utf8"));
const common = {
  NODE_ENV: "production",
...
assert(validateEnvironment("backup", {
  NODE_ENV: "production", APP_VERSION: "1.0.6", BUILD_ID: "a".repeat(40), APP_CHANNEL: "release",
...
console.log("1.0.6 release environment: 6 service contracts and secret-file boundaries PASS");
