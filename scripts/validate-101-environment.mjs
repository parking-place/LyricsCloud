...
assert(validateEnvironment("backup", {
  NODE_ENV: "production", APP_VERSION: "1.0.5", BUILD_ID: "a".repeat(40), APP_CHANNEL: "release",
...
console.log("1.0.5 release environment: 6 service contracts and secret-file boundaries PASS");
