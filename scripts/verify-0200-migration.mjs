...
try {
  ...
  try {
    ...
    await target.query(await readFile(resolve("packages/database/rollback/1130_public_lyric_guest_write.sql"), "utf8"));
    ...
    await target.query(await readFile(resolve("packages/database/rollback/1003_song_suno_workspaces.sql"), "utf8"));
    ...
    await target.query(await readFile(resolve("packages/database/rollback/1004_web_font_selection.sql"), "utf8"));
    ...
    await target.query(await readFile(resolve("packages/database/rollback/0701_recent_searches.sql"), "utf8"));
    await target.query(await readFile(resolve("packages/database/rollback/0700_search_foundation.sql"), "utf8"));
