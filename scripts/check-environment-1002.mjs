...
const schema = JSON.parse(await readFile(new URL("../config/environment-schema.1.0.0.json", import.meta.url), "utf8"));
...
if (process.argv[1] === fileURLToPath(import.meta.url)) {
  try {
    ...
    process.stdout.write(`1.0.0 ${process.argv[2]} environment: PASS\n`);
  } catch (error) {
